...
class _Page1State extends State<Page1> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      print("I am in initial");
      setState(() {
        _isDiscountVisible = true;
        print("_isDiscountVisible = true;");
      });
    });
  }
                              ...
                              GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    color: isClickedShop ? Colors.black : Colors.white,
                                  ),
                                  height: 35,
                                  width: 110,
                                  child: Center(
                                    child: Text(
                                      "Shop now",
                                      style: TextStyle(
                                        color: isClickedShop ? Colors.white : Color(0xFF9C9C9C),
                                        fontSize: 18,
